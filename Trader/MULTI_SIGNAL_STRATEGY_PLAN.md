...
- [x] Add focused tests for entry/exit asymmetry and reason persistence.
...
- [x] Disable 2-signal composite strategies in the active research loop.
- [x] Keep old `composite` tests as compatibility coverage.
- [x] Add planner tests proving active multi-signal candidates always satisfy
